...
latex_documents = [
    (master_doc, 'VinaysPersonalGithubPage.tex', 'Vinay\'s Personal Github Page Documentation',
...
man_pages = [
    (master_doc, 'vinayspersonalgithubpage', 'Vinay\'s Personal Github Page Documentation',
     [author], 1)
]
